...
def banner():
	os.system("clear")
	print(f"""____  _   _ __  __ ____    ___ ____
|  _ \| | | |  \/  |  _ \  |_ _|  _ \
| | | | | | | |\/| | |_) |  | || | | |
| |_| | |_| | |  | |  __/   | || |_| |
...
GitHub >> arvel-noob✓
Facebook >> ansyah arvel✓
________________________________________________
\t{garis} author by : Ansyah arvel""")              
...
def menu():
	...
	if hikmat in ["1","01"]:
		...
		x=f"{P2}sedang diarahkan ke whastapp author"
		vprint(panel(x,style=f"{H3}"))
		os.system('xdg-open https://wa.me/62838436141742?text=bang+script+mu+itu+ada+yang+error!!')
		input(f" {P}[{H}•{P}] kembali")
		menu()
	elif hikmat in ["9","09"]:
		print("")
